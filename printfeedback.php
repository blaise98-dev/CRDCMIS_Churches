...
font-family:"Times New Roman","serif"'>Printed by Church manager <?php
 $date = new DateTime();
 echo $date->format('Y');
 ?></span></b></p>
...
<?php
		$student_query = mysqli_query($con,"select * from members")or die(mysqli_error());
...
<table class=msoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <?php $query= mysqli_query($con,"select * from admin where admin_id = '$session_id'")or die(mysqli_error());
